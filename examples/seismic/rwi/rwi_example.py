...
from . import  RWIWaveSolver


def rwi_setup(shape=(50, 50, 50), spacing=(20.0, 20.0, 20.0), tn=250.0,
    ...
    return RWIWaveSolver(model, geometry, space_order=space_order,
...
def run(shape=(50, 50, 50), spacing=(20.0, 20.0, 20.0), tn=250.0,
    ...
    solver = rwi_setup(shape=shape, spacing=spacing, tn=tn, space_order=space_order,
